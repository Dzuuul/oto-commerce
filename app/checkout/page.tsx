...
export const metadata: Metadata = {
  title: "Checkout | OttoFikri",
  description: "Selesaikan pembelian mobil bekas Anda di OttoFikri",
};
              ...
              <div className="sticky top-24 space-y-6">
                <Card className="border shadow-sm overflow-hidden">
                  <div className="p-6">
                    ...
                    <div className="flex justify-between text-lg font-bold">
                      ...
                      <span>
                        {formatPrice(
                          car.price + 2500000 + car.price * 0.01 + 1000000
                        )}
                      </span>
                    </div>
                    ...
                    <div className="mt-6 flex items-center gap-2 rounded-lg bg-gray-50 p-4 text-sm">
                      ...
                      <p>
                        Pembayaran aman & terjamin dengan perlindungan pembeli
                        OttoFikri.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg border p-6 shadow-sm">
                  ...
                  <p className="text-gray-600 mb-4">
                    Tim kami siap membantu Anda dengan pertanyaan seputar proses
                    pembelian.
                  </p>
