...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Panduan lengkap untuk membeli mobil bekas yang berkualitas dan terhindar dari penipuan.",
  ...
  },
  {
    ...
    excerpt: "Pelajari cara merawat mobil bekas agar tetap dalam kondisi prima dan memperpanjang usia pakainya.",
    content: "Content goes here...",
    coverImage: "/placeholder.svg?height=600&width=800",
  ...
  },
  {
    ...
    excerpt: "Analisis tren pasar mobil bekas di Indonesia tahun 2023 dan prediksi untuk tahun mendatang.",
    content: "Content goes here...",
    coverImage: "/placeholder.svg?height=600&width=800",
  ...
  },
  {
    ...
    author: {
      name: "Joko Widodo",
      avatar: "/placeholder.svg?height=100&width=100",
      bio: "Kepala mekanik di AutoBekas dengan pengalaman 20 tahun",
    },
    readTime: 7,
  },
  {
    ...
    excerpt: "Tips dan trik untuk menegosiasikan harga mobil bekas dan mendapatkan penawaran terbaik.",
    content: "Content goes here...",
    coverImage: "/placeholder.svg?height=600&width=800",
...
export function getRelatedPosts(currentSlug: string, category?: string): BlogPost[] {
  ...
  if (category) {
    relatedPosts = relatedPosts.filter((post) => post.categories.includes(category))
  }
...
export function getBlogPostsByCategory(category: string): BlogPost[] {
  return blogPosts.filter((post) => post.categories.some((cat) => cat.toLowerCase().replace(/\s+/g, "-") === category))
}

// Function to get blog posts by tag
export function getBlogPostsByTag(tag: string): BlogPost[] {
  return blogPosts.filter((post) => post.tags.some((t) => t.toLowerCase().replace(/\s+/g, "-") === tag))
}
