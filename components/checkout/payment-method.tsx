                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Bayar penuh sekarang dan dapatkan mobil Anda segera
                ...
                <div className="rounded-lg border p-4 bg-gray-50">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Bayar uang muka sebesar 30% sekarang dan sisanya dalam
                        30 hari. Dokumen akan diserahkan setelah pembayaran
                        lunas.
                      </p>
                      <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-md flex items-start">
                        <AlertCircle className="h-5 w-5 text-yellow-600 mr-2 flex-shrink-0" />
                        <p className="text-sm text-yellow-800">
                          Pembayaran tempo memerlukan verifikasi tambahan dan
                          persetujuan dari tim kami.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-sm mt-1">
                        Transfer dari rekening bank Anda ke rekening OttoFikri.
                        Pembayaran akan diverifikasi dalam 1-2 jam kerja.
                      </p>
                    </Label>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-sm mt-1">
                        Pembayaran melalui virtual account dari bank pilihan
                        Anda. Pembayaran akan diverifikasi secara otomatis.
                      </p>
                    </Label>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start">
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-sm mt-1">
                        Pembayaran melalui e-wallet seperti GoPay, OVO, atau
                        DANA. Pembayaran akan diverifikasi secara otomatis.
                      </p>
                    </Label>
                  </div>
                </motion.div>
