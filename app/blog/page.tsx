...
export const metadata: Metadata = {
  title: "Blog | AutoBekas",
  description: "Artikel dan tips seputar mobil bekas di AutoBekas",
}
...
export default function BlogPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <FadeIn>
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Blog AutoBekas</h1>
          <p className="text-gray-600">Artikel, tips, dan berita terbaru seputar dunia otomotif</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          <div className="relative flex-grow">
            ...
            <Input type="text" placeholder="Cari artikel..." className="pl-10" />
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="relative h-10 w-10 rounded-full overflow-hidden mr-3">
                    <Image
                      src={featuredPost.authorImage || "/placeholder.svg?height=100&width=100"}
        ...
        <FadeIn className="mt-16">
          <div className="bg-gray-100 rounded-xl p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Berlangganan Newsletter Kami</h2>
              <p className="text-gray-600 mb-6">
                Dapatkan artikel terbaru, tips, dan penawaran eksklusif langsung ke email Anda.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <Input type="email" placeholder="Email Anda" className="flex-grow" />
                <Button className="bg-red-600 hover:bg-red-700">Berlangganan</Button>
              </div>
            </div>
          </div>
        </FadeIn>
