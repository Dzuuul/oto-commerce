...
export const metadata: Metadata = {
  title: "Detail Mobil | OttoFikri",
  description: "Lihat detail lengkap mobil bekas berkualitas di OttoFikri",
};
              ...
              <FadeIn>
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700">
                    {car.name} tahun {car.year} dalam kondisi{" "}
                    {car.condition.toLowerCase()}. Mobil ini telah melalui
                    inspeksi ketat oleh tim OttoFikri dan dinyatakan layak jual.
                    Mobil ini memiliki kilometer rendah dan terawat dengan baik
                    oleh pemilik sebelumnya.
                  </p>
                  <p className="text-gray-700">
                    Interior dan eksterior dalam kondisi prima. Mesin responsif
                    dan transmisi halus. Semua fitur keselamatan berfungsi
                    dengan baik. Dokumen lengkap dan pajak aktif.
                  </p>

                  <h3 className="text-lg font-semibold pt-2">Fitur Utama</h3>
                  <ul className="grid grid-cols-2 gap-2 text-gray-700">
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Garansi
                      Mesin 1 Tahun
                    </li>
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Bebas
                      Banjir & Tabrakan
                    </li>
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Dokumen
                      Lengkap
                    </li>
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Pajak
                      Aktif
                    </li>
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Servis
                      Rutin
                    </li>
                    <li className="flex items-center gap-2">
                      <ShieldCheck className="h-4 w-4 text-green-600" /> Buku
                      Manual & Servis
                    </li>
                  </ul>
                </div>
            ...
            <TabsContent value="history">
              <FadeIn>
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-medium">
                            Servis Berkala 40.000 km
                          </h4>
                          <p className="text-sm text-gray-500">
                            Bengkel Resmi {car.name.split(" ")[0]}
                          </p>
                        </div>
                      ...
                      <p className="mt-2 text-sm text-gray-700">
                        Ganti oli, filter oli, filter udara, filter kabin, cek
                        rem, cek suspensi, balancing & spooring.
                      </p>
                    </div>
                    <div className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                      ...
                      <p className="mt-2 text-sm text-gray-700">
                        Ganti oli, filter oli, cek rem, cek sistem pendingin,
                        cek baterai.
                      </p>
                    </div>
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="mt-2 text-sm text-gray-700">
                        Ganti oli, filter oli, filter udara, cek rem, cek
                        suspensi.
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-700">
                    Mobil ini merupakan tangan kedua. Pemilik pertama adalah
                    eksekutif perusahaan yang menggunakan mobil ini untuk
                    keperluan harian. Semua servis dilakukan di bengkel resmi
            ...
            <div className="sticky top-24 space-y-6">
              <div className="bg-white rounded-lg border p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    variant="ghost"
                    className="w-full text-base justify-start p-0 h-auto hover:bg-transparent"
                  >
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative h-12 w-12 rounded-full overflow-hidden">
                    <Image
                      ...
                      alt="OttoFikri Official"
                      fill
                      className="object-cover"
                    />
                  </div>
                  <div>
                    <h4 className="font-medium">OttoFikri Official</h4>
