...
export const metadata: Metadata = {
  title: "Daftar Mobil | AutoBekas",
  description: "Temukan mobil bekas berkualitas dengan harga terbaik di AutoBekas",
}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="hidden md:block w-full md:w-[23.6%] sticky top-24 self-start">
            <SlideIn direction="left">
              <div className="bg-white rounded-lg border shadow-sm p-6">
                ...
                <Accordion type="multiple" defaultValue={["brand", "price", "year", "condition"]} className="space-y-4">
                  <AccordionItem value="brand" className="border-b-0">
                    ...
                    <AccordionContent>
                      <div className="space-y-2 pt-1">
                        {["Toyota", "Honda", "Suzuki", "Daihatsu", "Mitsubishi", "Nissan", "Mazda"].map((brand) => (
                    ...
                    <AccordionContent>
                      <div className="space-y-4 pt-1">
                        ...
                        <div className="flex items-center justify-between">
                          <Input type="text" placeholder="Min" className="w-[45%]" defaultValue="Rp 50.000.000" />
                          <span className="text-gray-500">-</span>
                          <Input type="text" placeholder="Max" className="w-[45%]" defaultValue="Rp 250.000.000" />
                        </div>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="year" className="border-b-0">
                    ...
                    <AccordionContent>
                      <div className="space-y-4 pt-1">
                        <Slider defaultValue={[2018, 2023]} min={2010} max={2025} step={1} />
                        <div className="flex items-center justify-between">
                          <Input type="text" placeholder="Min" className="w-[45%]" defaultValue="2018" />
                          <span className="text-gray-500">-</span>
                          <Input type="text" placeholder="Max" className="w-[45%]" defaultValue="2023" />
                        </div>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="condition" className="border-b-0">
                    ...
                    <AccordionContent>
                      <div className="space-y-2 pt-1">
                        {["Sangat Baik", "Baik", "Cukup Baik"].map((condition) => (
                  ...
                  <AccordionItem value="fuel" className="border-b-0">
                    ...
                    <AccordionContent>
                      <div className="space-y-2 pt-1">
                        {["Bensin", "Diesel", "Listrik", "Hybrid"].map((fuel) => (
                ...
                <Button className="w-full bg-red-600 hover:bg-red-700">Terapkan Filter</Button>
              </div>
            </SlideIn>
          </div>
          ...
          <div className="w-full md:w-[76.4%]">
            ...
            <SlideIn direction="right">
              <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Daftar Mobil Bekas</h1>
                <p className="text-gray-600">Menampilkan {cars.length} mobil bekas berkualitas dengan harga terbaik</p>
              </div>
            </SlideIn>
