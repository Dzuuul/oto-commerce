...
export const metadata: Metadata = {
  title: "Favorit | OttoFikri",
  description: "Daftar mobil favorit Anda di OttoFikri",
};
      ...
      <FadeIn>
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Daftar mobil yang Anda simpan untuk dibandingkan atau dibeli nanti.
          </p>
        </div>
        ...
        {favoriteCars.length > 0 ? (
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pt-6">
              <p className="text-gray-600">
                Menampilkan {favoriteCars.length} mobil favorit
              </p>
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-600 text-center max-w-md mb-6">
                  Anda belum menyimpan mobil ke daftar favorit. Jelajahi daftar
                  mobil kami dan tambahkan ke favorit untuk melihatnya di sini.
                </p>
                <Button className="bg-red-600 hover:bg-red-700">
